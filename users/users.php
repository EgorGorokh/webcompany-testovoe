    ...
    <div class="postcontent"> 
        ...
        <p><a name="top"></a></p>
            ...
            <div style="display:inline-block">
                <form action="formAddOrSort.php" method="post" >
            ...
            <div class="filter">
                <form action="filterUsers.php" method="post">
...
if(isset($_COOKIE["filter"]) && isset($_COOKIE["sort_order_by_2"])==false) {
    $users=$dataBase->sortUsersWithFilter($connect, $_COOKIE["filter"]);
}
    elseif (isset($_COOKIE["sort_order_by_2"]) && isset($_COOKIE["filter"])==false) {
         $users=$dataBase->sortUsersWithOrder($connect,$_COOKIE["sort_name"] ,$_COOKIE["sort_order_by_2"]);
    }
    elseif(isset($_COOKIE["sort_order_by_2"]) && isset($_COOKIE["filter"]) ){
        $users=$dataBase->sortUsersWithOrderAndFilter($connect,$_COOKIE["sort_name"] ,$_COOKIE["sort_order_by_2"],$_COOKIE["filter"] );
    } else {
